...
export default function CreateListing() {
  ...
  const [formData, setFormData] = useState({
    type: "rent", name: "", bedrooms: 1, parking: false, furnished: false, address: "", description: "", offer: false, regularPrice: 0, discountedPrice: 0, latitude: 0, longitude: 0, images: {},
  });
  const {
    type, name, bedrooms, parking, address, furnished, description, offer, regularPrice, discountedPrice, latitude, longitude, images,
  } = formData;
  function onChange(e) {
    let boolean = null;
  ...
  return (
    <main className="max-w-md px-2 mx-auto">
      ...
      <form onSubmit={onSubmit}>
        ...
        <input type="text" id="name" value={name} onChange={onChange} placeholder="Title" maxLength="32" minLength="10" required className="w-full px-4 py-2 text-xl text-gray-700 bg-white border border-gray-300 rounded transition duration-150 ease-in-out focus:text-gray-700 focus:bg-white focus:border-slate-600 mb-6" />
        <div className="flex space-x-6 mb-6">
          ...
          {/* <div>
            <p className="text-lg font-semibold">Bathroom's</p>
